...
public class VoiceActivityDetectorTest {
  ...
  public void testSetSampleRate() throws IOException {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> VoiceActivityDetector.SampleRate.fromValue(1));
    assertTrue(
        vad.setSampleRate(VoiceActivityDetector.SampleRate.S32000), "sample rate configured");
  }
